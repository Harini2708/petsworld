	...
	<div class="container-fluid">
		...
		<div class="nav navbar"> 
			<img class="navbar-brand"
				src="<c:url value="/resource/images/logo1.png"/>"
				href="<c:url value="/index"/>" width="100px" height="100px"
				alt="logo-image"></img>
		</div>
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<c:url value="/index1" />">PetsWorld</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				<li><a href=" <c:url value="/index1" />">Home</a></li>
				<li><a href=" <c:url value="/getAllProducts" />">Pet
						List</a></li>
