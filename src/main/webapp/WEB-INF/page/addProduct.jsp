					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								<form:label path="productId">Dog Id</form:label>
								 <form:input type="text"
									placeholder="Enter DogId.." class="form-control"
									path="productId" disabled="true"></form:input>
							</div>
							<div class="col-sm-6 form-group">
								<form:label path="productName">Dog Name</form:label>
								 <form:input type="text"
									placeholder="Enter dog Name.." class="form-control"
						...
						<div class="form-group">
						<form:label path="productCategory">Breed Category</form:label>
								 <form:radiobutton path="productCategory" value="Lab"/>Lab
								 <form:radiobutton path="productCategory" value="Dane"/>Dane
								 <form:radiobutton path="productCategory" value="GermanSherpad"/>GermanSherpad
								 <form:radiobutton path="productCategory" value="SerbianHusky"/>SerbianHusky
						</div>
						<div class="row">
							<div class="col-sm-4 form-group">
								<form:label path="productManufacturer">Dog seller</form:label>
								 <form:input type="text"
